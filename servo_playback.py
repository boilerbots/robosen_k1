...
#1, 205, 
#1, 205])  # , 168
p2 = [254, 50, 254, 2, 108, 2, 72, 0, 212, 1, 37, 1, 94, 2, 153, 3, 17, 0, 164, 1, 196, 1, 208, 1, 166, 1, 211, 2, 195, 2, 150, 0, 212, 0, 248, 1, 205, 1, 205, 1, 205, 1, 205, 1, 130, 1, 130, 1, 205, 1, 205]  # , 166
...
initialize = [0xFA, 2, 7]  # , 3
enable = [0xFE, 3, 2, 1]  # , 4
disable = [0xFE, 3, 2, 0]
special = [0xFA, 0x03, 0x08, 0x00]
special2 = [0x16, 0x05, 0x09, 0x01, 0x01, 0xCD]
...
if True:
    ...
    while key_press != 'c':
        ...
        test = [channel, 0x02, 0x03]  # expect response about 0.28ms 0, 4, A3, 1, F4, 9C
        position(test)
        time.sleep(0.0020)
        #
